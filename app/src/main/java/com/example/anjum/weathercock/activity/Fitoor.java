...
/**
 * Created by ANJUM on 12/16/2017.
 */

public class Fitoor extends FragmentActivity implements AppCompatCallback,
        TaskStackBuilder.SupportParentable, ActionBarDrawerToggle.DelegateProvider {
    String appid = "26f4c901cba4740410b368d8b16a7f53";
    public String ceciliusUnicode = "℃";

    public String fahrenheitUnicode = "℉";

    public String pressureUnit = "hpa";

    public String windSpeed = "mps";

    public String percent = "%";

    public String kms = "kms";
...
// by ResourcesManager, so pull the current metrics from there.
     ...
     * {@link android.support.v7.app.AppCompatDelegate#FEATURE_SUPPORT_ACTION_BAR FEATURE_SUPPORT_ACTION_BAR}.</p>
     */
    @Override
...
// the window handling it
    ...
    public String convertUtcToDate(Long utc) {
    ...
    public String convertUtcToDaY(Long utc) {
        //convert seconds to milliseconds
        Date date = new Date(utc * 1000L);
